...
// Deterministic pseudo-image: striped placeholder w/ hue tint
...
const HERO_SLIDES = [
  {
    eyebrow: 'WEEKLY DROP',
    title: '$250,000 Vault\nUnlock Saturday',
    sub: 'Spin any qualifying slot to enter. The bigger you bet, the bigger your slice.',
    cta: 'Enter the Drop',
    hue: 290,
    badge: 'LIVE NOW'
  },
  {
    eyebrow: 'NEW ORIGINAL',
    title: 'Crash 100 is\nlive in beta',
    sub: 'Our flagship original \u2014 provably fair multipliers up to 1,000,000\u00d7.',
    cta: 'Play Crash 100',
    hue: 200,
    badge: 'BETA'
  },
  {
    eyebrow: 'TOURNAMENT',
    title: 'Race for $50K\nin 72 hours',
    sub: 'Top 100 players split the prize pool. Climb the leaderboard live.',
    cta: 'Join Race',
    hue: 340,
    badge: 'ENDS 2D 14H'
  }
...
window.LOBBY_DATA = { PROVIDERS, GAMES, HERO_SLIDES, PROMOS, WINNERS, TOURNAMENTS, RECENTLY_PLAYED };
